...
TARGET_BOOTLOADER_BOARD_NAME := a2109
...
BOARD_SYSTEMIMAGE_PARTITION_SIZE := 671088640 # 640 M
BOARD_CACHEIMAGE_PARTITION_SIZE := 805306368 # 768 M
BOARD_USERDATAIMAGE_PARTITION_SIZE := 14088667136 # 13.1 G
...
TARGET_KERNEL_CONFIG := cl2n_recovery_defconfig
...
BOARD_CUSTOM_BOOTIMG_MK := device/lenovo/a2109/recovery.mk
RECOVERY_SDCARD_ON_DATA := true
BOARD_HAS_NO_REAL_SDCARD := true
TW_NO_USB_STORAGE := false
TW_INCLUDE_CRYPTO := true
TW_EXCLUDE_TWRPAPP := true
# Unlegacy kernel includes generic battery driver for Lenovo IdeaTab A2109
